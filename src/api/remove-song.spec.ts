...
describe('remove-song handler', () => {
    ...
    beforeEach(() => {
        mockRemoveSongCommandHandler = new RemoveSongCommandHandler() as jest.Mocked<RemoveSongCommandHandler>;
        (RemoveSongCommandHandler as jest.Mock).mockImplementation(() => mockRemoveSongCommandHandler);
    });
